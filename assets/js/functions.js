...
(function($){
	...
	$(document).ready(function(){
		$("#nombre").blur(function(){ 
			var patron = new RegExp("([A-Z][a-z]+_[A-Z][a-z]+)$");
			var str = $('#nombre').val();
			var res = patron.test(str);
			if (res) {
		...
		$("#social").blur(function(){ 
			var patron = new RegExp("^[A-Za-z0-9_-]{6,16}$");
			var str = $('#social').val();
			var res = patron.test(str);
			if (res) {
				 $('#social').css("border", "2px solid green");
			}
			else{
				 $('#social').css("border", "2px solid red");	
			}
		});
